...
Being new to frontend web development, this project is an outlet for me to apply the web development knowledge I have learned at the start of my internship, and in more importantly to gain experience in using the React JS and Redux libaries.
...
## Application Layout
![Application layout](src/media/readme/)
...
![Click wall node](src/media/readme/)
![hold wall node](src/media/readme/)
...
Currently there are four search algorithms, two uninformed and two uninformed.
...
| Path     | Shows the length of the resultant path returned by the algorithm between the Start and End node. An optimal path would have the shortest length.   |

### Random Wall Generation
Manually drawing wall nodes is too time/effort consuming, users can generate a grid with randomly placed wall nodes:
...
![clear whole grid](src/media/readme/)
![clear grid except walls](src/media/readme/)
